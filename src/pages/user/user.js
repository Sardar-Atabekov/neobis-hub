...
const USerPage = (props) => {
    ...
    return (
        <div className="wrapper">
            {
                loading ? <><Title link={`/edit-user/${userData.id}`}>Карточка пользователя</Title>
                    <div>
                        <div className="d-flex mt-5 user-info-block">
                            ...
                            <div className="user-contacts">
                                <span><img src={mailSendIcon} alt="mailSendIcon" /> {userData.email} ElinaKarimova@gmail.com  </span>
                                <span><img src={phoneIcon} alt="phoneIcon" /> {userData.phone}</span>
                                <span><img src={telegramIcon} alt="telegramIcon" />{userData.telegram}</span>
                            </div>
                            <div className="p-4">
                                <span><img src={summaryIcon} alt="phoneIcon" /> Резюме </span>
                            </div>
                        </div>
                        <div className="d-flex mt-4">
                            <div className="w-70">
                                ...
                                <div className="user-projects">
                                    {
                                        userData.project.map(project => <div className="project">
                                            <div className="flex-start project-block">
                                                ...
                                                <div className="project-description text-left">
                                                    ...
                                                    <span className="project-span">Мобильное приложение</span>
                                                    <span className="pmIcon" >
                                                        <img src={pmIcon} alt="pm department icon" />
                                                    </span>
                                                    <span className="project-span">Проектный менеджер</span>
                                                    <p className="project-pm">Элина Каримова </p>
                                                </div>
                                                <span className={`project-status a`} >
                                                    Активный
                                                </span>
                                            </div>
                            ...
                            <div>
                                ...
                                <div className="pt-4">
                                    <StudyPlan icon={pmIcon} department={userData.department_name} />
                                </div>
                            </div>
                        </div>
                    </div></> : <Loading />
